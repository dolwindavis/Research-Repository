...
<div class="container-fluid mt--7">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="book-category" class="form-control" >
                                ...
                                @if($data['bookcategory'] == 'Book')
                                    ...
                                    <option value="Conference Proceeding">Chapter</option>
                                @elseif($data['bookcategory'] == 'Chapter')
    ...
    $(document).ready(function () {
        ...
        function changeSitesData(){
           ...
           if(fac != ""){
             ...
             window.location='/admin/books?faculty=' + fac;
    ...
    $(document).ready(function () {
        ...
        $('#book-category').on('change', changeSitesData);
        // $('#session_year').on('select2:select', changeSessionData);
        // $('#session_month').on('select2:select', changeSessionData);
        ...
        function changeSitesData(){
           ...
           var cat = $('#book-category :selected').val();
        
            if(cat != ""){

                window.location='/admin/books?bookcategory=' + cat;
    ...
    $(document).ready(function () {
        ...
        function changeSitesData(){
            ...
            if(year != ""){     
                ...
                window.location='/admin/books?year=' + year;
    ...
    $(document).ready(function () {
        ...
        function changeSitesData(){
            ...
            if(year != "" && month == ""){     
                ...
                window.location='/admin/books?month=' + month + '&year=' + year;
