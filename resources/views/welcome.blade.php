                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        $('#scrollable-dropdown-menu #search').typeahead({
                                            ...
                                            },-webkit-box-shadow: -5px -4px 13px -2px rgba(108, 99, 255, 1);
            -moz-box-shadow: -5px -4px 13px -2px rgba(108, 99, 255, 1);
            box-shadow: -5px -4px 13px -2px rgba(108, 99, 255, 1);
                                            templates: {
                                                ...
                                                suggestion: function (data) {
                                                    ...
                                                    return '<div class="box" style="margin:0px; height:70px; padding-top:10px"><a href="/profile/' +
                                                        ...
                                                        '</strong><br><small>' + data.searchable
                                            ...
                                            templates: {
                                                ...
                                                suggestion: function (data) {
                                                    ...
                                                    return '<div class="box" style="margin:0px; height:70px; padding-top:10px"><a href="/repository/' +
                                                        ...
                                                        '</strong><br><small>' + data.url +
                                                        '</small> @<small>' + data.searchable.user
                                                        .name +
